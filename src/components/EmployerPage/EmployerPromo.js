          ...
          <div className="promo__wrapper">
            <div className="promo__block employer-promo__block">
              <div className="employer-promo__txt">
                ...
                <h5>
                  Добро пожаловать на нашу страницу регистрации! Мы рады видеть
                  вас здесь.Мы ценим ваш интерес к нашей компании и надеемся на
                  успешное сотрудничество. Пожалуйста, заполните необходимые
                  поля, чтобы начать процесс регистрации.
                </h5>
              </div>
              <RegistrationForm />
            </div>
