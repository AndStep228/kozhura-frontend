...
export default function ForgotPassEnterPage({ forgotPassClick, regFormClick }) {
  const {
    handleSubmit,
    control,
    formState: { errors },
  ...
  return (
    <form className="form" onSubmit={handleSubmit(onSubmit)}>
      <h4>Введите почту и мы отправим на нее ссылку для подтверждения</h4>
      <div>
        <Controller
          name="email"
          control={control}
      ...
      <div className="form__btns">
        ...
        <Button btnType="submit" buttonTxt="Отправить" />
        <AnimatePresence>
